...
ALTER TABLE `DARBO_SUTARTYS`
  ...
  ADD CONSTRAINT `_3` FOREIGN KEY (`fk_DARBUOTOJAS`) REFERENCES `DARBUOTOJAI` (`id_`) ON DELETE CASCADE ON UPDATE RESTRICT;
...
ALTER TABLE `DARBUOTOJAI`
  ...
  ADD CONSTRAINT `_2` FOREIGN KEY (`fk_PARDUOTUVE`) REFERENCES `PARDUOTUVES` (`id_`) ON DELETE CASCADE ON UPDATE RESTRICT;

--
-- Apribojimai lentelei `FIRMOS`
--
ALTER TABLE `FIRMOS`
  ADD CONSTRAINT `_9` FOREIGN KEY (`fk_PRODUKTAS`) REFERENCES `PRODUKTAI` (`id_`) ON DELETE CASCADE ON UPDATE RESTRICT;

--
-- Apribojimai lentelei `KATEGORIJOS`
--
ALTER TABLE `KATEGORIJOS`
  ADD CONSTRAINT `_10` FOREIGN KEY (`fk_PRODUKTAS`) REFERENCES `PRODUKTAI` (`id_`) ON DELETE CASCADE ON UPDATE RESTRICT;

--
-- Apribojimai lentelei `KLIENTAI`
--
ALTER TABLE `KLIENTAI`
  ADD CONSTRAINT `KLIENTAI_ibfk_1` FOREIGN KEY (`dokumentas`) REFERENCES `DOKUMENTAS` (`id_`) ON DELETE CASCADE ON UPDATE RESTRICT;
...
ALTER TABLE `PALIKTI_KOMPIUTERIAI`
  ...
  ADD CONSTRAINT `_6` FOREIGN KEY (`fk_DARBUOTOJAS`) REFERENCES `DARBUOTOJAI` (`id_`) ON DELETE CASCADE ON UPDATE RESTRICT;

--
-- Apribojimai lentelei `PARDUOTUVES`
--
ALTER TABLE `PARDUOTUVES`
  ADD CONSTRAINT `_1` FOREIGN KEY (`fk_SAVININKAS`) REFERENCES `SAVININKAI` (`id_`) ON DELETE CASCADE ON UPDATE RESTRICT;

--
-- Apribojimai lentelei `PRODUKTAI`
--
ALTER TABLE `PRODUKTAI`
  ADD CONSTRAINT `_7` FOREIGN KEY (`fk_UZSAKYMAS`) REFERENCES `UZSAKYMAI` (`sutarties_nr`) ON DELETE CASCADE ON UPDATE RESTRICT;

--
-- Apribojimai lentelei `TRANSPORTAI`
--
ALTER TABLE `TRANSPORTAI`
  ADD CONSTRAINT `_4` FOREIGN KEY (`fk_DARBUOTOJAS`) REFERENCES `DARBUOTOJAI` (`id_`) ON DELETE CASCADE ON UPDATE RESTRICT;

--
-- Apribojimai lentelei `TRANSPORTO_DEFEKTAI`
--
ALTER TABLE `TRANSPORTO_DEFEKTAI`
  ADD CONSTRAINT `_8` FOREIGN KEY (`fk_TRANSPORTAS`) REFERENCES `TRANSPORTAI` (`id_`) ON DELETE CASCADE ON UPDATE RESTRICT;

--
-- Apribojimai lentelei `UZSAKYMAI`
--
ALTER TABLE `UZSAKYMAI`
  ADD CONSTRAINT `UZSAKYMAI_ibfk_1` FOREIGN KEY (`tipas`) REFERENCES `UZSAKYMO_TIPAS` (`id_`) ON DELETE CASCADE ON UPDATE RESTRICT,
  ADD CONSTRAINT `_5` FOREIGN KEY (`fk_KLIENTAS`) REFERENCES `KLIENTAI` (`id_`) ON DELETE CASCADE ON UPDATE RESTRICT;
...
ALTER TABLE `UZSAKYTOS_DETALES`
  ...
  ADD CONSTRAINT `_11` FOREIGN KEY (`fk_PALIKTAS_KOMPIUTERIS`) REFERENCES `PALIKTI_KOMPIUTERIAI` (`id_`) ON DELETE CASCADE ON UPDATE RESTRICT;
COMMIT;
